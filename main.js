...
global.channelLink = "https://whatsapp.com/channel/0029Vb7RwKa4IBhISgLOrE3w";
global.ytch = "Enzo Tech";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7RwKa4IBhISgLOrE3w' 
                }, { quoted: message });
                return;
